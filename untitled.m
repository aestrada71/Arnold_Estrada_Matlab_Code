...
targetPorphConcentration = 40e-6;  % Moles/liter of blood plasma
...
typicalWeight = 30;                 % of mouse in grams
...
%stockBSAWtByVol = (neededAlbuminMass_mol * albuminMolecWt) /
%porphInjectionVol  %grams / ml of soln