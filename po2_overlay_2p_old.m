...
%Update: 10/13/2007
    %Changed so that I could process old data with a slightly different
    %naming convention. -10/13/2007.
%Update: 10/16/2007    
    %Argument dots added, if argument is present, plot will not draw lines 
function overlay_2p_old(dots)
%Process argument
if (nargin ~= 1)
    dots=0;
else
...
a=avg_2p();
imagesc(a);
%Plot the data in the new txt file - lines or dots depending on input
%argument
hold on;
M
if (dots == 0)
