...
%needed to perform image-guided pO2 measurements in mice using oxyphor r2.

%% Given Parameters

targetPorphConcentration = 400e-6;  % Moles/liter of blood plasma
porphMolecWt = 2792;                % grams / mole
albuminMolecWt = 66432;             % grams / mole
stockPorphSolnVolume = 10;          % ml
stockFluorSolnVolume = 10;          % ml
totalInjectionVol = 0.150;            % ml
porphInjectionVol = 0.05;           % ml
fluorInjectionVol = 0.05;           % ml
